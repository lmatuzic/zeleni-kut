...
export type Bubara = Node & {
	__typename?: 'Bubara';
	content: BubaraContentRichText;
	/** The time the document was created */
	createdAt: Scalars['DateTime']['output'];
	/** User that created this document */
	createdBy?: Maybe<User>;
	/** Get the document in other stages */
	documentInStages: Array<Bubara>;
	/** List of Bubara versions */
	history: Array<Version>;
	/** The unique identifier */
	id: Scalars['ID']['output'];
	/** The time the document was published. Null on documents in draft stage. */
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BubaraCreatedByArgs = {
	forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
	locales?: InputMaybe<Array<Locale>>;
};

/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BubaraDocumentInStagesArgs = {
	includeCurrent?: Scalars['Boolean']['input'];
	inheritLocale?: Scalars['Boolean']['input'];
	stages?: Array<Stage>;
};
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BubaraPublishedByArgs = {
	forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
	locales?: InputMaybe<Array<Locale>>;
};

/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BubaraScheduledInArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BubaraUpdatedByArgs = {
	forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
	locales?: InputMaybe<Array<Locale>>;
};

export type BubaraConnectInput = {
	/** Allow to specify document position in list of connected documents, will default to appending at end of list */
	position?: InputMaybe<ConnectPositionInput>;
	/** Document to connect */
	where: BubaraWhereUniqueInput;
};

/** A connection to a list of items. */
export type BubaraConnection = {
	__typename?: 'BubaraConnection';
	aggregate: Aggregate;
	/** A list of edges. */
	edges: Array<BubaraEdge>;
	/** Information to aid in pagination. */
	pageInfo: PageInfo;
};

export type BubaraContentRichText = {
	__typename?: 'BubaraContentRichText';
	...
	references: Array<BubaraContentRichTextEmbeddedTypes>;
	/** Returns plain-text contents of RichText */
	text: Scalars['String']['output'];
};

export type BubaraContentRichTextReferencesArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
export type BubaraContentRichTextEmbeddedTypes = Asset;

export type BubaraCreateInput = {
...
export type BubaraCreateManyInlineInput = {
	/** Connect multiple existing Bubara documents */
	connect?: InputMaybe<Array<BubaraWhereUniqueInput>>;
	/** Create and connect multiple existing Bubara documents */
	create?: InputMaybe<Array<BubaraCreateInput>>;
};

export type BubaraCreateOneInlineInput = {
	/** Connect one existing Bubara document */
	connect?: InputMaybe<BubaraWhereUniqueInput>;
	/** Create and connect one Bubara document */
	create?: InputMaybe<BubaraCreateInput>;
};

/** An edge in a connection. */
export type BubaraEdge = {
	__typename?: 'BubaraEdge';
	/** A cursor for use in pagination. */
	cursor: Scalars['String']['output'];
	/** The item at the end of the edge. */
	node: Bubara;
...
/** Identifies documents */
export type BubaraManyWhereInput = {
	/** Logical AND on all given filters. */
	AND?: InputMaybe<Array<BubaraWhereInput>>;
	/** Logical NOT on all given filters combined by AND. */
	NOT?: InputMaybe<Array<BubaraWhereInput>>;
	/** Logical OR on all given filters. */
	OR?: InputMaybe<Array<BubaraWhereInput>>;
	/** Contains search across all appropriate fields. */
	_search?: InputMaybe<Scalars['String']['input']>;
	createdAt?: InputMaybe<Scalars['DateTime']['input']>;
	/** All values greater than the given value. */
	...
	createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
	createdBy?: InputMaybe<UserWhereInput>;
	documentInStages_every?: InputMaybe<BubaraWhereStageInput>;
	documentInStages_none?: InputMaybe<BubaraWhereStageInput>;
	documentInStages_some?: InputMaybe<BubaraWhereStageInput>;
	id?: InputMaybe<Scalars['ID']['input']>;
	/** All values containing the given string. */
	id_contains?: InputMaybe<Scalars['ID']['input']>;
	/** All values ending with the given string. */
...
export enum BubaraOrderByInput {
	CreatedAtAsc = 'createdAt_ASC',
	CreatedAtDesc = 'createdAt_DESC',
	IdAsc = 'id_ASC',
	IdDesc = 'id_DESC',
...
export type BubaraUpdateManyInlineInput = {
	/** Connect multiple existing Bubara documents */
	connect?: InputMaybe<Array<BubaraConnectInput>>;
	/** Create and connect multiple Bubara documents */
	create?: InputMaybe<Array<BubaraCreateInput>>;
	/** Delete multiple Bubara documents */
	delete?: InputMaybe<Array<BubaraWhereUniqueInput>>;
	/** Disconnect multiple Bubara documents */
	disconnect?: InputMaybe<Array<BubaraWhereUniqueInput>>;
	/** Override currently-connected documents with multiple existing Bubara documents */
	set?: InputMaybe<Array<BubaraWhereUniqueInput>>;
	/** Update multiple Bubara documents */
	update?: InputMaybe<Array<BubaraUpdateWithNestedWhereUniqueInput>>;
	/** Upsert multiple Bubara documents */
	upsert?: InputMaybe<Array<BubaraUpsertWithNestedWhereUniqueInput>>;
};

export type BubaraUpdateManyInput = {
	content?: InputMaybe<Scalars['RichTextAST']['input']>;
	subtitle?: InputMaybe<Scalars['String']['input']>;
	title?: InputMaybe<Scalars['String']['input']>;
};

export type BubaraUpdateManyWithNestedWhereInput = {
	/** Update many input */
	data: BubaraUpdateManyInput;
	/** Document search */
	where: BubaraWhereInput;
};

export type BubaraUpdateOneInlineInput = {
	/** Connect existing Bubara document */
	connect?: InputMaybe<BubaraWhereUniqueInput>;
	/** Create and connect one Bubara document */
	create?: InputMaybe<BubaraCreateInput>;
	/** Delete currently connected Bubara document */
	delete?: InputMaybe<Scalars['Boolean']['input']>;
	/** Disconnect currently connected Bubara document */
	disconnect?: InputMaybe<Scalars['Boolean']['input']>;
	/** Update single Bubara document */
	update?: InputMaybe<BubaraUpdateWithNestedWhereUniqueInput>;
	/** Upsert single Bubara document */
	upsert?: InputMaybe<BubaraUpsertWithNestedWhereUniqueInput>;
};

export type BubaraUpdateWithNestedWhereUniqueInput = {
	/** Document to update */
	data: BubaraUpdateInput;
	/** Unique document search */
	where: BubaraWhereUniqueInput;
};

export type BubaraUpsertInput = {
	/** Create document if it didn't exist */
	create: BubaraCreateInput;
	/** Update document if it exists */
	update: BubaraUpdateInput;
};

export type BubaraUpsertWithNestedWhereUniqueInput = {
	/** Upsert data */
	data: BubaraUpsertInput;
	/** Unique document search */
	where: BubaraWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type BubaraWhereComparatorInput = {
	/** This field can be used to request to check if the entry is outdated by internal comparison */
	outdated_to?: InputMaybe<Scalars['Boolean']['input']>;
};

/** Identifies documents */
export type BubaraWhereInput = {
	/** Logical AND on all given filters. */
	AND?: InputMaybe<Array<BubaraWhereInput>>;
	/** Logical NOT on all given filters combined by AND. */
	NOT?: InputMaybe<Array<BubaraWhereInput>>;
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type BubaraWhereStageInput = {
	/** Logical AND on all given filters. */
	AND?: InputMaybe<Array<BubaraWhereStageInput>>;
	/** Logical NOT on all given filters combined by AND. */
	NOT?: InputMaybe<Array<BubaraWhereStageInput>>;
	/** Logical OR on all given filters. */
	OR?: InputMaybe<Array<BubaraWhereStageInput>>;
	/** This field contains fields which can be set as true or false to specify an internal comparison */
	compareWithParent?: InputMaybe<BubaraWhereComparatorInput>;
	/** Specify the stage to compare with */
	stage?: InputMaybe<Stage>;
};

/** References Bubara record uniquely */
export type BubaraWhereUniqueInput = {
	id?: InputMaybe<Scalars['ID']['input']>;
	slug?: InputMaybe<Scalars['String']['input']>;
};
...
export type Mutation = {
	...
	/** Delete one bubara from _all_ existing stages. Returns deleted document. */
	deleteBubara?: Maybe<Bubara>;
	/**
	...
	/**
	 * Delete many Bubara documents
	 * @deprecated Please use the new paginated many mutation (deleteManyBubarasConnection)
	 */
	deleteManyBubaras: BatchPayload;
	/** Delete many Bubara documents, return deleted documents */
	deleteManyBubarasConnection: BubaraConnection;
	/**
	...
	/**
	 * Publish many Bubara documents
	 * @deprecated Please use the new paginated many mutation (publishManyBubarasConnection)
	 */
	publishManyBubaras: BatchPayload;
	/** Publish many Bubara documents */
	publishManyBubarasConnection: BubaraConnection;
	/**
	...
	/** Schedule to publish one bubara */
	schedulePublishBubara?: Maybe<Bubara>;
	/** Schedule to publish one menuCategory */
	schedulePublishMenuCategory?: Maybe<MenuCategory>;
	/** Unpublish one asset from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
	scheduleUnpublishAsset?: Maybe<Asset>;
	/** Unpublish one bubara from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
	scheduleUnpublishBubara?: Maybe<Bubara>;
	...
	/**
	 * Unpublish many Bubara documents
	 * @deprecated Please use the new paginated many mutation (unpublishManyBubarasConnection)
	 */
	unpublishManyBubaras: BatchPayload;
	/** Find many Bubara documents that match criteria in specified stage and unpublish from target stages */
	unpublishManyBubarasConnection: BubaraConnection;
	/**
	...
	/**
	 * Update many bubaras
	 * @deprecated Please use the new paginated many mutation (updateManyBubarasConnection)
	 */
	updateManyBubaras: BatchPayload;
	/** Update many Bubara documents */
	updateManyBubarasConnection: BubaraConnection;
	/**
...
export type MutationCreateBubaraArgs = {
	data: BubaraCreateInput;
};
...
export type MutationDeleteBubaraArgs = {
	where: BubaraWhereUniqueInput;
};
...
export type MutationDeleteManyBubarasArgs = {
	where?: InputMaybe<BubaraManyWhereInput>;
};

export type MutationDeleteManyBubarasConnectionArgs = {
	after?: InputMaybe<Scalars['ID']['input']>;
	before?: InputMaybe<Scalars['ID']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationPublishBubaraArgs = {
	to?: Array<Stage>;
	where: BubaraWhereUniqueInput;
};
...
export type MutationPublishManyBubarasArgs = {
	to?: Array<Stage>;
	where?: InputMaybe<BubaraManyWhereInput>;
};

export type MutationPublishManyBubarasConnectionArgs = {
	after?: InputMaybe<Scalars['ID']['input']>;
	before?: InputMaybe<Scalars['ID']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishBubaraArgs = {
	releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
	releaseId?: InputMaybe<Scalars['String']['input']>;
	to?: Array<Stage>;
	where: BubaraWhereUniqueInput;
...
export type MutationScheduleUnpublishBubaraArgs = {
	from?: Array<Stage>;
	releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
	releaseId?: InputMaybe<Scalars['String']['input']>;
	where: BubaraWhereUniqueInput;
...
export type MutationUnpublishBubaraArgs = {
	from?: Array<Stage>;
	where: BubaraWhereUniqueInput;
};
...
export type MutationUnpublishManyBubarasArgs = {
	from?: Array<Stage>;
	where?: InputMaybe<BubaraManyWhereInput>;
};

export type MutationUnpublishManyBubarasConnectionArgs = {
	after?: InputMaybe<Scalars['ID']['input']>;
	before?: InputMaybe<Scalars['ID']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	from?: Array<Stage>;
...
export type MutationUpdateBubaraArgs = {
	data: BubaraUpdateInput;
	where: BubaraWhereUniqueInput;
};
...
export type MutationUpdateManyBubarasArgs = {
	data: BubaraUpdateManyInput;
	where?: InputMaybe<BubaraManyWhereInput>;
};

export type MutationUpdateManyBubarasConnectionArgs = {
	after?: InputMaybe<Scalars['ID']['input']>;
	before?: InputMaybe<Scalars['ID']['input']>;
	data: BubaraUpdateManyInput;
	first?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationUpsertBubaraArgs = {
	upsert: BubaraUpsertInput;
	where: BubaraWhereUniqueInput;
};
...
export type Query = {
	...
	/** Retrieve a single bubara */
	bubara?: Maybe<Bubara>;
	/** Retrieve document version */
	bubaraVersion?: Maybe<DocumentVersion>;
	/** Retrieve multiple bubaras */
	bubaras: Array<Bubara>;
	/** Retrieve multiple bubaras using the Relay connection interface */
	bubarasConnection: BubaraConnection;
...
export type QueryBubaraArgs = {
	locales?: Array<Locale>;
	stage?: Stage;
	where: BubaraWhereUniqueInput;
};

export type QueryBubaraVersionArgs = {
	where: VersionWhereInput;
};

export type QueryBubarasArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
	locales?: Array<Locale>;
	orderBy?: InputMaybe<BubaraOrderByInput>;
	skip?: InputMaybe<Scalars['Int']['input']>;
	stage?: Stage;
	where?: InputMaybe<BubaraWhereInput>;
};

export type QueryBubarasConnectionArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
export type ScheduledOperationAffectedDocument = Asset | Bubara | MenuCategory;
