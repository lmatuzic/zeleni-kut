...
export type ScheduledOperationAffectedDocument = Asset | MenuCategory | MenuItem;
...
export type MenuItemsQuery = { __typename?: 'Query', menuItems: Array<{ __typename?: 'MenuItem', name: string, description: string, price: number, menuCategory?: { __typename?: 'MenuCategory', name: string, locale: Locale } | null }> };
